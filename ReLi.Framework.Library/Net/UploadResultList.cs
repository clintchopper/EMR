namespace ReLi.Framework.Library.Net
{
    ...
    public class UploadResultList : ObjectListBase<ITaskResult>
    {
        public UploadResultList()
            : base()
        { }

        public UploadResultList(IEnumerable<ITaskResult> objUploadResults)
            : base(objUploadResults)
        { }

        public UploadResultList(SerializedObject objSerializedObject)
            : base(objSerializedObject)
        { }

        public UploadResultList(BinaryReaderExtension objBinaryReader)
